...
```bash
node .agents/skills/confg-auth-core-full/scripts/create-auth-core-full.mjs
```

```bash
node .agents/skills/confg-auth-core-full/scripts/create-auth-core-full.mjs --scope @namespace --force
```

```bash
node .agents/skills/confg-auth-core-full/scripts/create-auth-core-full.mjs --force --run-tests
```

```bash
node .agents/skills/confg-auth-core-full/scripts/create-auth-core-full.mjs --force --skip-apps-sync --skip-install
```
