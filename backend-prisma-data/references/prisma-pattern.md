...
- Schema e modelos:
  ...
  - `apps/backend/prisma/models/*.model.prisma`
- Migrações:
...
- Schema modular por domínio (`auth.model.prisma`, `product.model.prisma`, `stock.model.prisma`, etc.).
...
- [ ] Alterar modelo no arquivo correto de `models/*.model.prisma`.
