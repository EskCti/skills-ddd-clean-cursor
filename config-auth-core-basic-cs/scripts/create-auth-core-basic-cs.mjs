...
/**
 * config-auth-core-basic-cs — scaffold auth domain in Core project
 *
 * Usage: node config-auth-core-basic-cs/scripts/create-auth-core-basic-cs.mjs [options]
...
console.log(`\n[done] Auth core basic scaffolded.\n`);
