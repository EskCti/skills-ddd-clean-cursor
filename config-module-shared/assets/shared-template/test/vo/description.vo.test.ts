...
describe("Description", () => {
	test("should create valid description with tryCreate", () => {
		const result = Description.tryCreate(
			"Esta descricao possui tamanho suficiente para ser valida.",
		);
	...
	test("should trim description before creating", () => {
		const result = Description.tryCreate(
			"   Esta descricao tambem possui tamanho minimo valido.   ",
		);
	...
	test("should create with create method", () => {
		const description = Description.create(
			"  Esta descricao foi criada com o metodo create com sucesso.  ",
		);
