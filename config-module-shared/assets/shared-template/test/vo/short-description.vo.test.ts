...
describe("ShortDescription", () => {
	...
	test("should trim short description before creating", () => {
		const result = ShortDescription.tryCreate(
			"   Esta e uma descricao curta valida.   ",
		);
	...
	test("should create with create method", () => {
		const shortDescription = ShortDescription.create(
			"  Esta e uma descricao curta criada com sucesso.  ",
		);
