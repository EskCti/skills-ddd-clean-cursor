...
export const errorMessagesEn: ErrorMessages = {
  ...
  WEAK_PASSWORD_TOO_SHORT: 'Password must be at least 8 characters.',
  WEAK_PASSWORD_NO_UPPERCASE: 'Password must contain an uppercase letter.',
  WEAK_PASSWORD_NO_LOWERCASE: 'Password must contain a lowercase letter.',
  WEAK_PASSWORD_NO_DIGIT: 'Password must contain a digit.',
  WEAK_PASSWORD_NO_SPECIAL: 'Password must contain a special character.',
