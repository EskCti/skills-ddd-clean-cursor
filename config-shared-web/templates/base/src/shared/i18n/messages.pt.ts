export const errorMessagesPt = {
  ...
  WEAK_PASSWORD_TOO_SHORT: 'A senha deve ter pelo menos 8 caracteres.',
  WEAK_PASSWORD_NO_UPPERCASE: 'A senha deve conter letra maiúscula.',
  WEAK_PASSWORD_NO_LOWERCASE: 'A senha deve conter letra minúscula.',
  WEAK_PASSWORD_NO_DIGIT: 'A senha deve conter um número.',
  WEAK_PASSWORD_NO_SPECIAL: 'A senha deve conter um caractere especial.',
